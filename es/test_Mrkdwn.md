...
<tr>
<td>Puede incluir etiquetas meta opcionales en el encabezado HTML como identificadores, en el formato de <code>&lt;meta name="amp4ads-id" content="vendor=${vendor},type=${type},id=${id}"&gt;</code> . Esas metaetiquetas deben colocarse antes del <code>amp4ads-v0.js</code> . El valor de <code>vendor</code> y <code>id</code> son cadenas que contienen solo [0-9a-zA-Z_-]. El valor de <code>type</code> es <code>creative-id</code> o <code>impression-id</code> .</td>
